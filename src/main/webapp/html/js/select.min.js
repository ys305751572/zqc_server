    ...
    e.prototype = {
        constructor: e, init: function () {
            ...
            if (f(), this.options.header && o.css("padding-top", 0), "auto" == this.options.size) {
                var v = function () {
                    var t;
                    f(), e = n - m, s.$newElement.toggleClass("dropup", i > n && e - m < o.height() && s.options.dropupAuto), s.$newElement.hasClass("dropup") && (e = i - m), t = o.find("li").length + o.find("dt").length > 3 ? 3 * d + m - 2 : 0, o.css({
                        "max-height": e + "px",
                        overflow: "hidden",
                        "min-height": "auto"
                    }), a.css({"max-height": e - h - c + "px", "overflow-y": "auto", "min-height": "auto"})
                };
                ...
                e = d * this.options.size + w * r + c, this.$newElement.toggleClass("dropup", i > n && e < o.height() && this.options.dropupAuto), o.css({
                    "max-height": e + h + "px",
                    overflow: "hidden"
                }), a.css({"max-height": e - c + "px", "overflow-y": "auto"})
            }
        }, setWidth: function () {
            ...
            var e, i, n = this, s = "<div />", o = t(s), a = function (t) {
                o.addClass(t.attr("class")).toggleClass("dropup", t.hasClass("dropup")), e = t.offset(), i = t.hasClass("dropup") ? 0 : t[0].offsetHeight, o.css({
                    top: e.top + i,
                    left: e.left,
            ...
            /(13 | 32) /
            .
                test(e.keyCode) && (e.preventDefault(), t(":focus").click(), t(document).data("keycount", 0))
            }
        }, hide: function () {
        ...
        var s, o = arguments, a = this.each(function () {
            if (t(this).is("select")) {
                ...
                if (l) {
                    ...
                    a.data("selectpicker", l = new e(this, d, n));
                }
                if ("string" == typeof i) {
                    var r = i;
        ...
        dropupAuto: !0,
        header: !1
    }, t(document).data("keycount", 0).on("keydown", "[data-toggle=dropdown], [role=menu]", e.prototype.keydown)
}(window.jQuery);