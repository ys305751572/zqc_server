!function () {
    ...
    t = this, e = function () {
        ...
        return e.prototype.set_default_values = function () {
            ...
            for (this.no_results_clear(), o = 0, r = this.get_search_text(), a = this.search_contains ? "" : "^", n = new RegExp(a + r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), c = new RegExp(r.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"), f = this.results_data, u = 0, h = f.length; h > u; u++)if (e = f[u], !e.empty)if (e.group)e.search_match = !1; else {
                if (e.search_match = !1, n.test(e.html))e.search_match = !0, o += 1; else if (this.enable_split_word_search && (e.html.indexOf(" ") >= 0 || 0 === e.html.indexOf("[")) && (i = e.html.replace(/\[|\]/g, "").split(" "), i.length))for (d = 0, p = i.length; p > d; d++)t = i[d], n.test(t) && (e.search_match = !0, o += 1);
    ...
    var e, t, i, n, a = {}.hasOwnProperty, o = function (e, t) {
        function i() {
            this.constructor = e
        }
    ...
    i = this, e = jQuery, e.fn.extend({
        ...
        return o(a, t), a.prototype.setup = function () {
            ...
            var i, n;
            return n = this.results_data[t], this.form_field.options[n.options_index].disabled ? !1 : (n.selected = !1, this.form_field.options[n.options_index].selected = !1, this.selected_option_count = null, i = e("#" + this.container_id + "_o_" + t), i.removeClass("result-selected").addClass("active-result").show(), this.result_clear_highlight(), this.results_showing && this.winnow_results(), this.form_field_jq.trigger("change", {deselected: this.form_field.options[n.options_index].value}), this.search_field_scale(), !0)
            ...
            if (this.is_multiple) {
                ...
                return t = e("<div />", {style: a}), t.text(this.search_field.val()), e("body").append(t), r = t.width() + 25, t.remove(), this.f_width || (this.f_width = this.container.outerWidth()), r > this.f_width - 10 && (r = this.f_width - 10), this.search_field.css({width: r + "px"})
            }
